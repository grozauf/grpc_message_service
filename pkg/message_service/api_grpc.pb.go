...
type MessageServiceClient interface {
	SayIt(ctx context.Context, in *RequestMS, opts ...grpc.CallOption) (*ResponseMS, error)
}
...
func (c *messageServiceClient) SayIt(ctx context.Context, in *RequestMS, opts ...grpc.CallOption) (*ResponseMS, error) {
	out := new(ResponseMS)
...
type MessageServiceServer interface {
	SayIt(context.Context, *RequestMS) (*ResponseMS, error)
...
func (UnimplementedMessageServiceServer) SayIt(context.Context, *RequestMS) (*ResponseMS, error) {
...
func _MessageService_SayIt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageServiceServer).SayIt(ctx, req.(*RequestMS))
	}
